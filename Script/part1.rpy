label PartOne:
    ...
    call Afterword from _call_Afterword
...
label AfterAmayaStory:
    ...
    scene black
    centered 'End of Demo \n Click to continue to the afterword...'(what_color="fff")
    stop music
...
label Afterword:
    show street_summer_day with fade
    show sen_cat_smile
    'An Afterword from the creator:'
    sen 'Thank you for playing the demo of My Love is Cursed.'
    sen 'I hope you enjoyed reading it.'
    sen 'This is my first visual novel.'
    sen 'I am writing a light novel of the same name. It will be another first
    for me.'
    sen 'While writing the book, I realized it could be a VN.'
    sen 'I am happy to make this. It is exciting bringing my ideas into the world
     and seeing them in front of my eyes.'

    sen 'Please let me know if you liked the story and the premise... or didn\'t.'
    sen 'If I know people enjoy it, I\'ll add the rest of the book as a VN.'

    sen 'Send feedback or inquiries to: myloveiscursed@gmail.com'
    sen 'You may also reach me on Discord as murmur#8689 or twitter @SenjougaharaAri'
    sen 'I look forward to hearing from you.
    Thank you again for your support, and most importantly, your time.'
